...
Kindly utilise the templates provided in the `.github` directory of the main branch to create PRs. You can also go adventurous if you have something fun in your mind, but kindly maintain a similar workflow by taking the already available templates as a reference.
...
## Add upstream remote
$ git remote add upstream https://github.com/Crio-WFH/Chrome-extensions.git
# - OR -
$ git remote add upstream git@github.com:Crio-WFH/Chrome-extensions.git
