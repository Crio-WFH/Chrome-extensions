...
var createPopupText=function(txt,e){
    ...
    x.setAttribute("style","width:320px;border-width:10px;background-color: #f8f0f0;position:absolute;text-overflow:inherit;background-image: url(Images/bg.jpg);border-color: #111111;" );
